...
SELECT * FROM PEOPLE;
SELECT * FROM PEOPLE_HEALTH_SECURITY;
SELECT * FROM MASTER_CONTRACTS;

USE talentohumano360;
SELECT * FROM HIRING_ORDER;
SELECT * FROM PEOPLE;
SELECT * FROM BUSINESS_PEOPLE_DATA;
SELECT * FROM PEOPLE_HEALT_SECURITY;
SELECT * FROM PEOPLE_EXTENDED_INFO;
DESCRIBE PEOPLE_EXTENDED_INFO;
DESCRIBE USERS;
SELECT * FROM PEOPLE_DETAILS;
SELECT * FROM MASTER_ARL;
SELECT role_id, name_role FROM ROLES WHERE name_role IN ('LIDER', 'ANALISTA');

SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE HIRING_ORDER;
TRUNCATE TABLE PEOPLE;
TRUNCATE TABLE BUSINESS_PEOPLE_DATA;
TRUNCATE TABLE PEOPLE_HEALT_SECURITY;
TRUNCATE TABLE PEOPLE_EXTENDED_INFO;
...
ALTER TABLE HIRING_ORDER 
MODIFY COLUMN detail_justification TEXT;
DESCRIBE MASTER_LEADER;
SELECT * FROM master_leader LIMIT 3;

SHOW COLUMNS FROM HIRING_ORDER LIKE 'analyst%';

-- 1. Agregar columna analyst_id a HIRING_ORDER
ALTER TABLE HIRING_ORDER 
ADD COLUMN analyst_id INT NULL,
