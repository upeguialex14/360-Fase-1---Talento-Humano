    ...
    try {
        ...
        const sql = `
            CREATE TABLE IF NOT EXISTS base_datos_maestra (
                ...
                autorizacion_tramite_datos VARCHAR(255),
                expedicion_documento VARCHAR(100),
                genero VARCHAR(50),
                orientacion_sexual VARCHAR(50),
                poblacion_especial VARCHAR(50),
                ...
                cuenta_vehiculo_propio VARCHAR(10),
                nro_hijos VARCHAR(10),
                ...
                familiar_en_empresa VARCHAR(10),
                compania VARCHAR(100),
                parentesco VARCHAR(100),
                hv_referida TEXT,
                nombre_referido VARCHAR(255),
                familiares_pep VARCHAR(10),
                porque_pep TEXT,
        ...
        console.log('Tabla base_datos_maestra creada exitosamente');
        await conn.end();
    } catch (err) {
